...
namespace Owin.WebSocket.Extensions
{
    public static class OwinExtension
    {
        ...
        public static void MapWebSocketRoute<T>(this IAppBuilder app, string route, IServiceProvider serviceLocator = null) 
        ...
        /// <param name="serviceLocator">Service locator to use for getting instances of T</param>
        public static void MapWebSocketPattern<T>(this IAppBuilder app, string regexPatternMatch, IServiceProvider serviceLocator = null)
            where T : WebSocketConnection
        {
        ...
        /// <param name="app">Owin App</param>
        /// <param name="serviceLocator">Service locator to use for getting instances of T</param>
        public static void MapWebSocketRoute<T>(this IAppBuilder app, IServiceProvider serviceLocator = null)
            where T : WebSocketConnection
        {
